...
<body>
    ...
    <div class="container text-center my-4 col-lg-7 col-xl-7">
        <h1 class="display-4">View Cashier's Info</h1>
            ...
            <?php
                ...
                function showCashier(){
                    ...
                    if($result->num_rows > 0){
                        ...
                        echo "<p class='lead'>There are no cashier's</p>";
                    }
                }
    ...
    <div class="container text-center my-4 col-lg-6 col-xl-6">
        <h1 class="display-4">Add Cashier's Information</h1>
        <div class="container text-center col-lg-7 col-xl-7">
            <form method="POST" action="cashierdata.php">
                <div class="form-group">
                    <input type="text" class="form-control my-2" name="name" placeholder="Cashier's name">
                    ...
                    <input type="submit" class="form-control my-2 btn btn-outline-primary" value="Add Cashier" name="add">
                </div>
            </form>
        </div>
        <?php
            ...
            function add_manager(){
                ...
                if(($name and $phone and $address and $salary) != NULL){
                    $sql = "INSERT INTO pharmacy_login VALUES('$name','$name','cashier')";
                    $conn->query($sql);
                    $sql = "INSERT INTO cashier VALUES ('$name',$phone,'$address',$salary)";
                    $conn->query($sql);
                    header("Location: cashierdata.php");
                }
            }
        ?>
    </div>
    ...
    <div class="container text-center my-4 col-lg-6 col-xl-6">
        <h1 class="display-4">Update Cashier's Information</h1>
        ...
        <?php
            ...
            function update_cashier(){
                ...
                $column = $_POST["column"];
                $newval = $_POST["newval"];
                $sql = "UPDATE cashier SET $column='$newval' WHERE $column='$oldval'";
                $conn->query($sql);
                header("Location: cashierdata.php");
            }
        ?>
    ...
    <div class="container text-center my-4 col-lg-6 col-xl-6">
        <h1 class="display-4">Delete Cashier's Information</h1>
        <div class="container text-center col-lg-7 col-xl-7">
            <div class="form-group">
                <form method="POST" action="cashierdata.php">
                    <label for="del_val">Select Cashier's name to delete</label>
        ...
        <?php
            ...
            function deletelogin(){
                global $conn;
                $val = $_POST["delval"];
                $sql = "DELETE FROM cashier WHERE name='$val'";
                $conn->query($sql);
