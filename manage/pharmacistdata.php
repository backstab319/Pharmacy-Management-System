...
<body>
    ...
    <div class="container text-center my-4 col-lg-7 col-xl-7">
        <h1 class="display-4">View Pharmacist's Info</h1>
            ...
            <?php
                ...
                function showpharmacist(){
                    ...
                    if($result->num_rows > 0){
                        ...
                        echo "<p class='lead'>There are no pharmacist's</p>";
                    }
                }
    ...
    <div class="container text-center my-4 col-lg-6 col-xl-6">
        <h1 class="display-4">Add Pharmacist's Information</h1>
        <div class="container text-center col-lg-7 col-xl-7">
            <form method="POST" action="pharmacistdata.php">
                <div class="form-group">
                    <input type="text" class="form-control my-2" name="name" placeholder="Pharmacist's name">
                    ...
                    <input type="submit" class="form-control my-2 btn btn-outline-primary" value="Add pharmacist" name="add">
                </div>
            </form>
        </div>
        <?php
            ...
            function add_pharmacist(){
                ...
                if(($name and $phone and $address and $salary) != NULL){
                    $sql = "INSERT INTO pharmacy_login VALUES('$name','$name','pharmacist')";
                    $conn->query($sql);
                    $sql = "INSERT INTO pharmacist VALUES ('$name',$phone,'$address',$salary)";
                    $conn->query($sql);
                    header("Location: pharmacistdata.php");
                }
            }
        ?>
    </div>
    ...
    <div class="container text-center my-4 col-lg-6 col-xl-6">
        <h1 class="display-4">Update Pharmacist's Information</h1>
        ...
        <?php
            ...
            function update_pharmacist(){
                ...
                $column = $_POST["column"];
                $newval = $_POST["newval"];
                $sql = "UPDATE pharmacist SET $column='$newval' WHERE $column='$oldval'";
                $conn->query($sql);
                header("Location: pharmacistdata.php");
            }
        ?>
    ...
    <div class="container text-center my-4 col-lg-6 col-xl-6">
        <h1 class="display-4">Delete Pharmacist's Information</h1>
        <div class="container text-center col-lg-7 col-xl-7">
            <div class="form-group">
                <form method="POST" action="pharmacistdata.php">
                    <label for="del_val">Select pharmacist's name to delete</label>
        ...
        <?php
            ...
            function deletelogin(){
                global $conn;
                $val = $_POST["delval"];
                $sql = "DELETE FROM pharmacist WHERE name='$val'";
                $conn->query($sql);
